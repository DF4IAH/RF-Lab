========================================================================
    WIN32-ANWENDUNG: RF-Lab_Win32-Projektübersicht
========================================================================

Diese RF-Lab_Win32-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre RF-Lab_Win32-Anwendung besteht.


RF-Lab_Win32.vcxproj
...
RF-Lab_Win32.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol (32x32) verwendet wird. Dieses Symbol ist in der Hauptressourcendatei "RF-Lab_Win32.rc"     enthalten.

small.ico
    Dies ist eine Symboldatei, die eine kleinere Version (16x16) des Anwendungssymbols enthält. Dieses Symbol ist in der Hauptressourcendatei "RF-Lab_Win32.rc"     enthalten.

/////////////////////////////////////////////////////////////////////////////
Andere Standarddateien:

StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen RF-Lab_Win32.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
